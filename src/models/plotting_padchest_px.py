...
def plot_confidence():
    ...
    confidence_data = {
        "Train_data": ("mean_probability_per_layer_train.csv", config.REPORTS_DIR_PADCHEST_PX, config.FIGURES_DIR_PADCHEST_PX),
        "Test_data": ("mean_probability_per_layer_test.csv", config.REPORTS_DIR_PADCHEST_PX, config.FIGURES_DIR_PADCHEST_PX),
        "Test_data_scanner_IDC": ("mean_probability_per_layer_ImagingDynamicsCompanyLtd.csv", config.REPORTS_DIR_PADCHEST_SCANNER_PX, config.FIGURES_DIR_PADCHEST_SCANNER_PX),
        "Test_data_scanner_PMS": ("mean_probability_per_layer_PhilipsMedicalSystems.csv", config.REPORTS_DIR_PADCHEST_SCANNER_PX, config.FIGURES_DIR_PADCHEST_SCANNER_PX),
        "Test_data_female": ("mean_probability_per_layer_female.csv", config.REPORTS_DIR_PADCHEST_SEX_PX, config.FIGURES_DIR_PADCHEST_SEX_PX),
        "Test_data_male": ("mean_probability_per_layer_male.csv", config.REPORTS_DIR_PADCHEST_SEX_PX, config.FIGURES_DIR_PADCHEST_SEX_PX),
    }
