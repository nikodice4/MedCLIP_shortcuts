...
def plot_confidence():
    ...
    ax.set_xlabel("Building block", fontdict = {'fontsize' : 16})
    ...
    ax.set_xlabel("Building block", fontdict = {'fontsize' : 16})
    ax.set_ylabel("Confidence", fontdict = {'fontsize' : 16})
    ax.set_title("Confidence per building block drains \n NIH-CXR14, pneumothorax", fontsize=18, loc='center')
    ax.set_xticks(df["layer"].unique())
...
############### GOLD LABEL x DRAIN COMBINED
    ...
    ax.set_xlabel("Building block", fontdict = {'fontsize' : 16})
    ax.set_ylabel("Confidence", fontdict = {'fontsize' : 16})
    ax.set_title("Confidence per building block patient sex \n NIH-CXR14, pneumothorax", fontsize=18, loc='center')
    ax.set_xticks(layers_x)
    ax.legend(fontsize=14)
    ax.grid(axis='y')
    ax.set_ylim(0, 0.5)
...
def plot_confidence_padchest():
    ...
    ax.set_xlabel("Building block", fontdict = {'fontsize' : 16})
    ax.set_ylabel("Confidence", fontdict = {'fontsize' : 16})
    ax.set_title("Confidence per building block overall \n PadChest, cardiomegaly", fontsize=18, loc='center')
    ax.set_xticks(df["layer"].unique())
    ax.legend()
    ax.grid(axis='y')
    ax.set_ylim(0, 0.5)
    ...
    ax.set_xlabel("Building block", fontdict = {'fontsize' : 16})
    ax.set_ylabel("Confidence", fontdict = {'fontsize' : 16})
    ax.set_title("Confidence per building block scanner machines \n PadChest, cardiomegaly", fontsize=18, loc='center')
    ax.set_xticks(df["layer"].unique())
    ax.legend()
    ax.grid(axis='y')
    ax.set_ylim(0, 0.5)
...
def calibration_curves_scanner_padchest():
    ...
    plt.xlabel('Mean predicted probability',fontdict = {'fontsize' : 16})
    plt.ylabel('Fraction of positives',fontdict = {'fontsize' : 16})
    plt.title("Calibration curve for scanner machines \n PadChest, cardiomegaly", fontsize=20)
    plt.xticks(fontsize=20)
    plt.yticks(fontsize=20)
    plt.legend(fontsize=20)
...
def calibration_curves_scanner_padchest_px():
    ...
    plt.xlabel('Mean predicted probability',fontdict = {'fontsize' : 16})
    plt.ylabel('Fraction of positives',fontdict = {'fontsize' : 16})
    plt.title("Calibration curve for scanner machines \n PadChest, pneumothorax", fontsize=20)
    plt.xticks(fontsize=20)
    plt.yticks(fontsize=20)
    plt.legend(fontsize=20)
