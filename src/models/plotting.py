...
def plot_confidence():
    ...
    confidence_data = {
        "Train_data": ("mean_probability_per_layer_train.csv", config.REPORTS_DIR, config.FIGURES_DIR),
        "Test_data": ("mean_probability_per_layer_test.csv", config.REPORTS_DIR, config.FIGURES_DIR),
        "Test_data_drains": ("mean_probability_per_layer_drain.csv", config.REPORTS_DIR_DRAIN, config.FIGURES_DIR_DRAIN),
        "Test_data_nodrains": ("mean_probability_per_layer_nodrain.csv", config.REPORTS_DIR_DRAIN, config.FIGURES_DIR_DRAIN),
        "Test_data_female": ("mean_probability_per_layer_female.csv", config.REPORTS_DIR_SEX, config.FIGURES_DIR_SEX),
        "Test_data_male": ("mean_probability_per_layer_male.csv", config.REPORTS_DIR_SEX, config.FIGURES_DIR_SEX),
    }
